...
import { setIsLoaded } from '@redux/actions/userProfile';
          ...
          <div className="user-profile__top">
            <div className="user-profile__header">
              ...
              <div className="user-profile__titles">
                ...
                <h1 className="user-profile__author-nickname _author-nickname">{nickName}</h1>
              </div>
            </div>
            ...
            <div className="user-profile__footer">
              <div className="user-profile__stats stats-user">
                <div className="stats-user__info stats-user__info--following">
                  <strong className="stats-user__count">{numberFormatting(followingCount)}</strong>
                  <span className="stats-user__desc">Подписки</span>
                </div>
                <div className="stats-user__info stats-user__info--follower">
                  <strong className="stats-user__count">{numberFormatting(followerCount)}</strong>
                  <span className="stats-user__desc">Подписчики</span>
                </div>
                <div className="stats-user__info stats-user__info--likes">
                  <strong className="stats-user__count">{numberFormatting(heartCount)}</strong>
                ...
                posts.map(({ video, views }, i) => (
                  <li key={`${i}: ${views}`} className="user-profile__post post-user">
                    <video
                      ...
                      preload="metadata"
                      src={video}
                      className="post-user__video _author-video"></video>
                    <div className="post-user__stats">
                      ...
                      <strong className="post-user__stats-views">{numberFormatting(views)}</strong>
                    </div>
                  </li>
                ))}
            </ul>
